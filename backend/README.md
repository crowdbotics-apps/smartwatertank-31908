...
## Project Structure
    ...
    ├── smartwatertank_31908  # Django project configurations
...
1. Clone this repo and `cd smartwatertank_31908`
...
2. Clone this repo and `cd smartwatertank_31908`
